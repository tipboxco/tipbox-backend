...
-- CreateEnum
CREATE TYPE "achievement_goal_type" AS ENUM ('POST', 'INVENTORY', 'LIKE_GIVEN', 'LIKE_RECEIVED', 'COMMENT');
...
CREATE TABLE "achievement_goals" (
    ...
    "goal_type" "achievement_goal_type",
...
-- CreateIndex
CREATE INDEX "achievement_goals_goal_type_idx" ON "achievement_goals"("goal_type");
