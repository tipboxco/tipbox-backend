...
-- CreateEnum
CREATE TYPE "badge_type" AS ENUM ('COLLECTION', 'EVENT', 'COSMETIC', 'BRAND');

-- CreateEnum
CREATE TYPE "main_action" AS ENUM ('POST', 'LIKE', 'COMMENT', 'BOOKMARK', 'JOIN', 'SYSTEM');
...
-- CreateEnum
CREATE TYPE "wallet_provider" AS ENUM ('METAMASK', 'WALLETCONNECT', 'CUSTOM', 'THIRDWEB');

-- CreateEnum
CREATE TYPE "transaction_action_type" AS ENUM ('TIP_SEND', 'TIP_RECEIVE', 'CLAIM_REWARD', 'CLAIM_BADGE', 'NFT_BUY', 'NFT_SELL', 'SWAP_TIP_TO_SOL', 'SWAP_SOL_TO_TIP', 'AIRDROP', 'FEE', 'DEPOSIT', 'WITHDRAW', 'BOOST_POST');
...
-- CreateEnum
CREATE TYPE "event_feed_type" AS ENUM ('PICKS', 'ROASTS');

-- CreateEnum
CREATE TYPE "event_reward_type" AS ENUM ('TIPS', 'BADGE', 'TITLE');
...
-- CreateEnum
CREATE TYPE "thirdweb_webhook_status" AS ENUM ('sent', 'mined', 'errored', 'cancelled');

-- CreateEnum
CREATE TYPE "thirdweb_onchain_status" AS ENUM ('success', 'reverted');
...
CREATE TABLE "user_settings" (
    ...
    "gamification_notifications" BOOLEAN NOT NULL DEFAULT true,
    "expert_notifications" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "badge_collections" (
    ...
    CONSTRAINT "badge_collections_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "badge_reminders" (
    "id" UUID NOT NULL,
    "user_id" UUID NOT NULL,
    "badge_id" UUID NOT NULL,
...
-- CreateTable
CREATE TABLE "user_survey_completions" (
    "id" UUID NOT NULL,
    "user_id" UUID NOT NULL,
    "survey_id" UUID NOT NULL,
...
CREATE TABLE "events" (
    ...
    "feed_type" "event_feed_type" NOT NULL DEFAULT 'PICKS',
    "product_id" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "image_url" TEXT,
...
CREATE TABLE "event_rewards" (
    ...
    "user_id" UUID NOT NULL,
    "event_id" VARCHAR(26) NOT NULL,
    "reward_type" "event_reward_type" NOT NULL,
...
-- CreateTable
CREATE TABLE "thirdweb_webhook_logs" (
    "id" UUID NOT NULL,
    "queue_id" TEXT NOT NULL,
    "status" "thirdweb_webhook_status" NOT NULL,
    "onchain_status" "thirdweb_onchain_status",
    ...
    CONSTRAINT "thirdweb_webhook_logs_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "content_posts_product_status_idx" ON "content_posts"("product_status");
...
-- CreateIndex
CREATE INDEX "badge_reminders_user_id_idx" ON "badge_reminders"("user_id");

-- CreateIndex
CREATE INDEX "badge_reminders_badge_id_idx" ON "badge_reminders"("badge_id");

-- CreateIndex
CREATE INDEX "badge_reminders_remind_at_idx" ON "badge_reminders"("remind_at");

-- CreateIndex
CREATE UNIQUE INDEX "action_types_main_action_code_key" ON "action_types"("main_action", "code");
...
-- CreateIndex
CREATE INDEX "achievement_goals_chain_id_idx" ON "achievement_goals"("chain_id");

-- CreateIndex
CREATE INDEX "achievement_goals_main_action_action_type_id_idx" ON "achievement_goals"("main_action", "action_type_id");
...
-- CreateIndex
CREATE INDEX "user_survey_completions_user_id_idx" ON "user_survey_completions"("user_id");

-- CreateIndex
CREATE INDEX "user_survey_completions_survey_id_idx" ON "user_survey_completions"("survey_id");

-- CreateIndex
CREATE UNIQUE INDEX "user_survey_completions_user_id_survey_id_key" ON "user_survey_completions"("user_id", "survey_id");
...
-- CreateIndex
CREATE INDEX "nfts_token_id_contract_address_idx" ON "nfts"("token_id", "contract_address");

-- CreateIndex
CREATE UNIQUE INDEX "nfts_token_id_contract_address_key" ON "nfts"("token_id", "contract_address");
...
-- CreateIndex
CREATE INDEX "events_status_start_date_end_date_idx" ON "events"("status", "start_date", "end_date");

-- CreateIndex
CREATE INDEX "events_main_category_id_idx" ON "events"("main_category_id");

-- CreateIndex
CREATE UNIQUE INDEX "event_stats_user_id_event_id_key" ON "event_stats"("user_id", "event_id");

-- CreateIndex
CREATE INDEX "event_rewards_user_id_idx" ON "event_rewards"("user_id");

-- CreateIndex
CREATE INDEX "event_rewards_event_id_idx" ON "event_rewards"("event_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "event_badges_event_id_rank_key" ON "event_badges"("event_id", "rank");
...
-- CreateIndex
CREATE UNIQUE INDEX "thirdweb_webhook_logs_queue_id_key" ON "thirdweb_webhook_logs"("queue_id");

-- CreateIndex
CREATE INDEX "thirdweb_webhook_logs_queue_id_idx" ON "thirdweb_webhook_logs"("queue_id");

-- CreateIndex
CREATE INDEX "thirdweb_webhook_logs_transaction_hash_idx" ON "thirdweb_webhook_logs"("transaction_hash");

-- CreateIndex
CREATE INDEX "thirdweb_webhook_logs_status_idx" ON "thirdweb_webhook_logs"("status");

-- CreateIndex
CREATE INDEX "thirdweb_webhook_logs_processed_at_idx" ON "thirdweb_webhook_logs"("processed_at");

-- CreateIndex
CREATE INDEX "thirdweb_webhook_logs_transaction_id_idx" ON "thirdweb_webhook_logs"("transaction_id");
...
-- AddForeignKey
ALTER TABLE "content_posts" ADD CONSTRAINT "content_posts_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "events"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "badges" ADD CONSTRAINT "badges_collection_id_fkey" FOREIGN KEY ("collection_id") REFERENCES "badge_collections"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "badge_collections" ADD CONSTRAINT "badge_collections_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "achievement_goals" ADD CONSTRAINT "achievement_goals_chain_id_fkey" FOREIGN KEY ("chain_id") REFERENCES "achievement_chains"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "achievement_goals" ADD CONSTRAINT "achievement_goals_collection_id_fkey" FOREIGN KEY ("collection_id") REFERENCES "badge_collections"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "achievement_goals" ADD CONSTRAINT "achievement_goals_action_type_id_fkey" FOREIGN KEY ("action_type_id") REFERENCES "action_types"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "brand_categories" ADD CONSTRAINT "brand_categories_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_survey_completions" ADD CONSTRAINT "user_survey_completions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_survey_completions" ADD CONSTRAINT "user_survey_completions_survey_id_fkey" FOREIGN KEY ("survey_id") REFERENCES "brand_surveys"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "events" ADD CONSTRAINT "events_brand_id_fkey" FOREIGN KEY ("brand_id") REFERENCES "brands"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "events" ADD CONSTRAINT "events_main_category_id_fkey" FOREIGN KEY ("main_category_id") REFERENCES "main_categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "events" ADD CONSTRAINT "events_sub_category_id_fkey" FOREIGN KEY ("sub_category_id") REFERENCES "sub_categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "event_stats" ADD CONSTRAINT "event_stats_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "event_rewards" ADD CONSTRAINT "event_rewards_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "event_rewards" ADD CONSTRAINT "event_rewards_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "event_badges" ADD CONSTRAINT "event_badges_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "thirdweb_webhook_logs" ADD CONSTRAINT "thirdweb_webhook_logs_transaction_id_fkey" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE SET NULL ON UPDATE CASCADE;
