...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const themes = yield Promise.all([
        ...
        const mainCategories = yield Promise.all([
        ...
        const badgeCategories = yield Promise.all([
        ...
        const badges = yield Promise.all([
            // Achievement Badges
            prisma.badge.create({
                data: {
                    name: 'Welcome',
        ...
        const metrics = yield Promise.all([
        ...
        const techSubCategories = yield Promise.all([
