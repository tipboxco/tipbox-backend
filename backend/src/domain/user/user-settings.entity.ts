...
export class UserSettings {
  constructor(
    ...
    public readonly trustNotifications: boolean,
    public readonly supportNotifications: boolean,
    public readonly messageNotifications: boolean,
    public readonly collectionNotifications: boolean,
    public readonly postNotifications: boolean,
    public readonly nftNotifications: boolean,
    public readonly rewardNotifications: boolean,
    public readonly transactionNotifications: boolean,
    public readonly walletNotifications: boolean,
    public readonly gamificationNotifications: boolean,
    public readonly expertNotifications: boolean,
    public readonly eventNotifications: boolean,
