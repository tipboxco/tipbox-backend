...
/**
 * @openapi
 * /api/brands/{brandId}/surveys/{surveyId}/questions:
 *   get:
 *     summary: Get survey questions
 *     description: Returns all questions and options for the specified survey within a brand.
 *     tags: [Brand Catalog]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 */
router.get(
  '/:brandId/surveys/:surveyId/questions',
  asyncHandler(async (req: Request, res: Response) => {
...
/**
 * @openapi
 * /api/brands/{brandId}/surveys/{surveyId}/submit:
 *   post:
 ...
 */
router.post(
  '/:brandId/surveys/:surveyId/submit',
  asyncHandler(async (req: Request, res: Response) => {
    const { surveyId } = req.params;
