/**
 * Tuna (Tunab) kullanıcısından Georgia Green (omer@tipbox.co) kullanıcısına mesaj gönder
 */
...
const GEORGIA_USER_ID = '480f5de9-b691-4d70-a6a8-2789226f4e07'; // Georgia Green (omer@tipbox.co)
const DEFAULT_PASSWORD = 'password123';

async function sendMessage() {
  try {
    console.log('🔐 Tuna (Tunab) olarak giriş yapılıyor...\n');
    ...
    // 2. Mesaj gönder
    const message = 'Merhaba Georgia! Tuna buradan mesaj gönderiyor.';
