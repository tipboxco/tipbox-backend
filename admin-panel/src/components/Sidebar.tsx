...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'brands-news', label: 'News', path: '/news' },
    ],
  },
  {
    key: 'gamification',
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'billing-invoices', label: 'Invoices', path: '/billing/invoices' },
      { key: 'billing-subscriptions', label: 'Subscriptions', path: '/billing/subscriptions' },
      { key: 'billing-subscription-plans', label: 'Subscription Plans', path: '/billing/subscription-plans' },
      { key: 'billing-rewards', label: 'Rewards', path: '/billing/rewards' },
      { key: 'billing-reward-claims', label: 'Reward Claims', path: '/billing/reward-claims' },
    ],
  },
  {
    key: 'web3',
    ...
    label: 'Web3',
    children: [
      { key: 'web3-wallets', label: 'Wallets', path: '/web3/wallets' },
      { key: 'web3-nfts', label: 'NFTs', path: '/web3/nfts' },
      { key: 'web3-marketplace', label: 'NFT Marketplace', path: '/web3/marketplace' },
      { key: 'web3-transfers', label: 'Token Transfers', path: '/web3/transfers' },
      { key: 'web3-tips', label: 'Tips Management', path: '/web3/tips' },
    ],
  },
  {
    key: 'messaging',
    ...
    children: [
      { key: 'messaging-notifications', label: 'Notifications', path: '/messaging/notifications' },
      { key: 'messaging-messages', label: 'Direct Messages', path: '/messaging/messages' },
      { key: 'messaging-support', label: 'Support Requests', path: '/messaging/support' },
      { key: 'messaging-dm-sessions', label: 'DM Support Sessions', path: '/messaging/dm-sessions' },
      { key: 'messaging-experts', label: 'Expert Requests', path: '/messaging/experts' },
    ],
  },
  {
    key: 'analytics',
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'moderation-dm', label: 'DM Moderation', path: '/moderation/dm-moderation' },
      { key: 'moderation-actions', label: 'Moderation Actions', path: '/moderation/actions' },
    ],
  },
  {
    key: 'marketing',
